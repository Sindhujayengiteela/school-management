...
Connection con;
	...
	try
	{
		...
		String qry="select rollno,first_name,dob,gender,email,address,phno from student";
        ...
        <table width="100%" height="349" border="1">
            <tr>
              ...
              <td width="84%" rowspan="9"><table width="100%" border="1">
                <tr>
                  <td colspan="8"><div align="center" class="style12">Bio-Data Details </div></td>
                </tr>
                <tr>
                  <td width="15%"><div align="center">Roll Number </div></td>
                  <td width="14%"><div align="center">Name</div></td>
                  <td width="14%"><div align="center">Date Of Birth </div></td>
                  <td width="9%"><div align="center">Gender</div></td>
