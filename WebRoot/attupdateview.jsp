...
<%
	try
		...
		System.out.println("sdfsdfds");
			...
			ResultSet rs=st.executeQuery("select * from attendence where rollno='"+roll+"'");
...
<body>
<form action="attupdateinsert.jsp">
<div align="center">
                  ...
                  <tr>
                    <td width="92">YEAR</td>
                      <td width="152"><label></label>
                        <div align="center">
                          <input type="text" name="year" value="<%=rs.getString(2) %>" />
                        </div></td>
                    </tr>
                  <tr>
                    <td>SEM</td>
                      <td><input type="text" name="sem"  value="<%=rs.getString(3)%>"/></td>
                    </tr>
                  <tr>
                    <td>Attendance</td>
                      <td><input type="text" name="att"  value="<%=rs.getString(4)%>"/></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                      <td><label>
