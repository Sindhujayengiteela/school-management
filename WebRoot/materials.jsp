        ...
        <table width="100%" height="349" border="1">
            <tr>
              ...
              <td width="84%" rowspan="9"><table width="100%" border="1">
                <tr>
                  <td colspan="4"><div align="center" class="style12">Materials List </div></td>
                  </tr>
                <tr>
                  <td valign="top">Year </td><td width="25%"><div align="center">&amp; Sem </div></td>
                  <td width="23%"><div align="center">Subject</div></td>
                  <td width="24%"><div align="center">Document</div></td>
                  <td width="28%"><div align="center">Lesson Plan </div></td>
                </tr>
                <%while(rs.next())
                {
