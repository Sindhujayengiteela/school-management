            ...
            <tr>
              ...
              <td width="84%" rowspan="9"><div align="center">
                <table width="100%" border="0">
                  <tr>
                    <td colspan="5"><div align="center" class="style12">Materials List </div></td>
                   </tr>
                  <tr>
                    <td valign="top">Year</td><td width="19%"><div align="center">&nbsp;Sem</div></td>
                    <td width="22%"><div align="center">Subject</div></td>
                    <td width="23%"><div align="center">Document</div></td>
                    <td width="18%"><div align="center">Lesson Plan </div></td>
                    <td width="18%"><div align="center">Delete</div></td>
                  ...
                  <tr><td valign="top"><%=rs.getInt(1) %></td><td width="19%"><div align="center">&nbsp;<%=rs.getInt(2) %></div></td>
                    <td width="22%"><div align="center"><%=rs.getString(3) %></div></td>
                    <td width="23%"><div align="center"><%=rs.getString(4) %></div></td>
                    <td width="18%"><div align="center"><%=rs.getString(5) %></div></td>
                    <td width="18%"><div align="center"><a href='materialdelete.jsp?id=<%=rs.getString(6)%>'>Delete</a></div></td>
                  </tr>
                  <%}
                  }
                  catch(Exception e)
                ...
                <div align="center">To Post New Materials,<a href="materials1.html">Click Here </a></div></td>
            </tr>
            </table>
      </div></td>
     </tr></table></div></form>
