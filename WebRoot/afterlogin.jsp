            ...
            <tr>
              <td width="16%"><p><a href="materials.jsp">Materials</a><br />
                ...
                <br />
                    ...
                    <br />
                    <a href="transport.html">Teansport Details</a><br />
                    <br />
                    <a href="attendance.html">Attendence</a><br />
                    <br />
                    <a href="result.html">Results</a></p>
<p><a href="comunicatestudent.html">Communicate with Lect</a></p><p><a href="showanswer.html">Show Answer from LECT</a></p></td>
              <td width="84%" rowspan="9"></td>
            </tr>
            </table>
      </div></td>
     </tr></table></div></form>
