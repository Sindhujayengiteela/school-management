        ...
        <table width="100%" height="349" border="1">
            <tr>
              ...
              <td width="84%" rowspan="9"><table width="100%" border="1">
                <tr>
                  <td colspan="5"><div align="center" class="style12">Transport Details </div></td>
                </tr>
                <tr>
                  <td width="15%"><div align="center">Roll Number </div></td>
                  <td width="14%"><div align="center">Year</div></td>
                   <td width="14%"><div align="center">Sem</div></td>
                  <td width="14%"><div align="center">From Location </div></td>
                  <td width="9%"><div align="center">To Location </div></td>
                </tr>
                <%while(rs.next())
                {
