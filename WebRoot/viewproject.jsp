        ...
        <table width="100%" height="349" border="1">
            <tr>
              ...
              <td width="84%" rowspan="9"><table width="100%" border="1">
                <tr>
                  <td colspan="4"><div align="center" class="style12">Projects List </div></td>
                  </tr>
                <tr>
                  <td width="23%"><div align="center">RollNo</div></td>
                  <td width="24%"><div align="center">Project Title</div></td>
                  <td width="28%"><div align="center">Project Description </div></td>
                </tr>
                <%while(rs.next())
                {
