...
rs=pst.executeQuery("select ATTENDENCE from ATTENDENCE where YEAR='"+year+"' and SEM='"+sem+"' and ROLLNO='"+roll+"'");
if(rs.next())
{
%>
        ...
        <table width="100%" height="349" border="1">
            <tr>
              <td width="16%"><p><a href="materials.jsp">Materials</a><br />
                    <br />
                    <a href="timetable.jsp">Timetable</a><br />
                    <br />
              ...
              <td width="84%" rowspan="9"><div align="center"><table><tr><td>
              UR Attendance Percentage is:</td><td><%=rs.getString(1) %></td>
            </tr>
            <tr><td><a href="attendance.html">back</a></td></tr>
            </table>
      </div></td>
     </tr></table></div>
...
{
%>
			<jsp:forward page="afterattendence.html"/>
