...
try
	...
	id=request.getParameter("id");
		...
		rs=pst.executeQuery("select * from STUDENTS_COMUNICATE where LECTURETID='"+id+"'");
		while(rs.next())
		{
...
<body>
<form action="showrequestupdate.jsp">
<div align="center">
    ...
    <tr>
      <td height="404" colspan="9" bgcolor="#9BD439"><div align="center">
        <table width="100%" height="349" border="1">
            <tr>
              <td width="16%"><p><a href="showreuest.html">Show Request from Student </a></p>
                </td>
              ...
              <td width="84%" rowspan="9"><label>
                ...
                <div align="center">
                  <table width="480" border="1">
                      ...
                      <tr>
                        <td><label>
                          <input type="checkbox" name="checkbox" value="<%=rollno%>" />
                        </label></td>
                        <td><%=rollno%>&nbsp;</td>
                        <td><%=name %>&nbsp;</td>
                        <td><%=query %>&nbsp;</td>
                      </tr>
                                  </table><br /><input type="submit" name="button1" /><br />
                      <%}
                         catch(Exception e)
                              {
                               e.printStackTrace();
