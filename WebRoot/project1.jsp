            ...
            <tr>
              ...
              <td width="84%" rowspan="9"><div align="center">
                <table width="100%" border="1">
                  <tr>
                    <td colspan="4"><div align="center" class="style12">Project Details </div></td>
                  </tr>
                  <tr>
                    <td width="15%"><div align="center">Roll Number </div></td>
                    <td width="14%"><div align="center">Project Title </div></td>
                    <td width="14%"><div align="center">Project</div></td>
                    </tr>
                  <%while(rs.next())
                {
