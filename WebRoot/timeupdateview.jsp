...
<%!Connection con;
	...
	try
		...
		System.out.println("sdfsdfds");
			...
			ResultSet rs=st.executeQuery("select * from timetable where day='"+day+"'");
			System.out.println("sdfsdfds==="+day);
			while(rs.next())
			{
			%>
...
<body>
<form action="timeupdateinsert.jsp">
<div align="center">
            ...
            <tr>
              ...
              <td width="84%" rowspan="9"><div align="center">
                <table width="260" border="1">
                  <tr>
                    <td valign="top">day<br /></td>
                      <td valign="top"><input type="text" name="day"  value="<%=rs.getString(1)%>"/></td>
                    </tr>
                 
                    
                  <tr>
                    <td>First</td>
                      <td><input type="text" name="one"  value="<%=rs.getString(2)%>"/></td>
                    </tr>
                  <tr>
                    <td>second</td>
                      <td><input type="text" name="two"  value="<%=rs.getString(3)%>"/></td>
                    </tr>
                  <tr>
                    <td>Third</td>
                      <td><label>
                        <input type="text" name="three" value="<%=rs.getString(4)%>" />
                        </label></td>
                    </tr>
                    <tr>
                    <td>Fourth</td>
                      <td><label>
                        <input type="text" name="four" value="<%=rs.getString(5)%>" />
                        </label></td>
                    </tr><tr>
                    <td>Fifth</td>
                      <td><label>
                        <input type="text" name="Five" value="<%=rs.getString(6)%>" />
                        </label></td>
                    </tr>
                    <tr>
                    <td>Sixth</td>
                      <td><label>
                        <input type="text" name="six" value="<%=rs.getString(7)%>" />
                        </label></td>
                    </tr><tr>
                    <td>Seventh</td>
                      <td><label>
                        <input type="text" name="seven" value="<%=rs.getString(8)%>" />
                        </label></td>
                    </tr>
                     <tr>
                    <td width="92">YEAR</td>
                      <td width="152"><label></label>
                        <div align="center">
                          <input type="text" name="year" value="<%=rs.getString(9) %>" />
                        </div></td>
                    </tr>
                  <tr>
                    <td>SEM</td>
                      <td><input type="text" name="sem"  value="<%=rs.getString(10)%>"/></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                      <td><label>
