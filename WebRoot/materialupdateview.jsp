...
<%!Connection con;
	...
	try
		...
		System.out.println("sdfsdfds");
			...
			ResultSet rs=st.executeQuery("select * from MATERIALS where id='"+id+"'");
			System.out.println("sdfsdfds==="+id);
			while(rs.next())
			{
			%>
...
<body>
<form action="materialupdateinsert.jsp">
<div align="center">
                ...
                <table width="260" border="1">
                  <tr>
                    <td valign="top">id<br /></td>
                      <td valign="top"><input type="text" name="id"  value="<%=rs.getString(6)%>"/></td>
                    </tr>
                  <tr>
                    <td width="92">YEAR</td>
                  ...
                  <tr>
                    <td>ATTACHMENT</td>
                      <td><input type="text" name="attach"  value="<%=rs.getString(4)%>"/></td>
                    </tr>
                  <tr>
                    <td>LESSONPLAN</td>
                      <td><label>
                        <input type="text" name="less" value="<%=rs.getString(5)%>" />
                        </label></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
